            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= site_url(); ?>Dashboard/printPDF" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Laporan</a>
                    </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Kepuasan Pelayanan</h6>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php foreach ($dim->result() as $row) { ?>
                                        <h4 class="small font-weight-bold"><?= $row->dimensi ?> <span class="float-right"><?= $row->avr ?></span></h4>
                                        <div class="progress mb-4">
                                            <div title="<?= $row->per ?> %" class="progress-bar <?= $row->clr ?>" role="progressbar" style="width: <?= $row->per ?>%" aria-valuenow="<?= $row->dimensi ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    <?php } ?>

			...
			<div class="container-fluid px-4">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/emphaty/add') ?>"><i class="fas fa-plus"></i> Tambahkan</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<?php $no =0;?>
									...
									<tr>
										...
										<td width="100" >
											<div class="row">
												<a href="<?php echo site_url('admin/emphaty/edit/'.$pernyataan->id) ?>"
												class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
												<a href="<?php echo site_url('admin/emphaty/delete/'.$pernyataan->id) ?>" 
